document.addEventListener('DOMContentLoaded', () => {
    ...
    // =========================================================================
    // 3. FUNÇÕES DE FLUXO (VALIDAÇÃO E RENDERIZAÇÃO)
    // =========================================================================
        ...
        Elements.paymentForm.addEventListener('submit', (e) => {
            ...
            if (validateStep2()) {
                ...
                setTimeout(() => {
                    ...
                    // CORREÇÃO: Comentar a remoção de 'currentOrder' para que a tela de confirmação
                    // (renderStep 3) possa ler o total corretamente.
